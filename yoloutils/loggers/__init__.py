...
from yoloutils.general import LOGGER, colorstr, cv2
from yoloutils.loggers.clearml.clearml_utils import ClearmlLogger
from yoloutils.loggers.wandb.wandb_utils import WandbLogger
from yoloutils.plots import plot_images, plot_labels, plot_results
from yoloutils.torch_utils import de_parallel
...
try:
    if RANK not in [0, -1]:
        ...
        from yoloutils.loggers.comet import CometLogger
...
class GenericLogger:
    ...
    Usage: from yoloutils.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
